            ...
            <div>
                ...
                <div className="container">
                    <div style={{ display: "flex", justifyContent: "space-between" }}>
                        ...
                        <div style={{ display: "flex", width: "350px", height: "240px", marginTop: "5px" }}>
                            <div >
                                <img style={{ width: "333px", height: "223px" }} src={this.state.avatar ? `http://localhost:5000/${this.state.avatar}` : ""} />
                            </div>
                        </div>
                    </div>
